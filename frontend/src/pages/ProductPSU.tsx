    ...
    (term: string) => {
      const filtered = [...products].filter(
        (product) =>
          ...
          product.standard.toLowerCase().includes(term.toLowerCase()) ||
          product.power.toLowerCase().includes(term.toLowerCase())
      );
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {displayedProducts.map((product) => (
          <div key={product.id} className="border rounded p-4">
            ...
            <p className="text-gray-600 mt-4">Công suất : {product.power}</p>
